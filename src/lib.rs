...
use arch::{_mm_setzero_si128, __m128i, _mm_loadu_si128, _mm_xor_si128, _mm_storeu_si128, _mm_set_epi64x};

pub use aead::{self, NewAead, AeadCore, AeadInPlace, Error};
pub use cipher::Key;

use cipher::{KeyInit, KeySizeUser, BlockCipher, BlockSizeUser, BlockEncrypt, BlockDecrypt, consts::{U16, U8, U0}, generic_array::{GenericArray, ArrayLength}};
...
impl<B, NonceSize> KeySizeUser for Colm0<B, NonceSize> where B: KeyInit, {
    type KeySize = B::KeySize;
}

impl<B, NonceSize> NewAead for Colm0<B, NonceSize> where B: BlockSizeUser<BlockSize = U16> + BlockEncrypt + BlockDecrypt + KeyInit, {
    type KeySize = B::KeySize;
...
impl<B, NonceSize> From<B> for Colm0<B, NonceSize> where B: BlockSizeUser<BlockSize = U16> + BlockEncrypt + BlockDecrypt,
{
...
impl<B, NonceSize> AeadCore for Colm0<B, NonceSize> where NonceSize: ArrayLength<u8> {
    type NonceSize = NonceSize;
    type TagSize = U16;
    type CiphertextOverhead = U0;
}

impl<B, NonceSize> AeadInPlace for Colm0<B, NonceSize> where B: BlockCipher + BlockSizeUser<BlockSize = U16> + BlockEncrypt + BlockDecrypt, NonceSize: ArrayLength<u8>, 
{
    fn encrypt_in_place_detached(
            ...
            unsafe {
                ...
                while remaining > 16 {
                    ...
                    // Load current complete block into inb
                    ...
                    _mm_storeu_si128(buffer[block_start..block_end].as_ptr() as *mut __m128i, byte_swap(block));
                ...
                _mm_storeu_si128(buffer[block_start..].as_ptr() as *mut __m128i, byte_swap(block));
